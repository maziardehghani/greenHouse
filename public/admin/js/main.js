...
function customizer() {
    ...
    $cusHtml += '<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#sections-setting">Sidebar</a></li>';
    ...
    $cusHtml += '<div class="tab-pane fade show active" id="sections-setting">';
